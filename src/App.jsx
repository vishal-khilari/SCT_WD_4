        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <div className="flex-1 flex items-center gap-2 px-4 py-2 border-2 border-gray-200 rounded-xl">
            ...
            <button
              onClick={addTask}
              className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
            >
                ...
                {editingId === task.id ? (
                  <div className="p-6 space-y-4">
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-indigo-300 rounded-xl focus:border-indigo-500 focus:outline-none text-lg"
                      autoFocus
                    />
                    <div className="flex gap-3">
                      <div className="flex-1 flex items-center gap-2 px-4 py-2 border-2 border-gray-200 rounded-xl">
                    ...
                    <div className="flex gap-3">
                      <button
                        onClick={saveEdit}
                        className="flex-1 bg-green-600 text-white py-2 rounded-xl font-medium hover:bg-green-700 transition-colors duration-200 flex items-center justify-center gap-2"
                      >
                      ...
                      <button
                        onClick={cancelEdit}
                        className="flex-1 bg-gray-300 text-gray-700 py-2 rounded-xl font-medium hover:bg-gray-400 transition-colors duration-200 flex items-center justify-center gap-2"
                      >
                        <X className="w-4 h-4" />
                        Cancel
                      </button>
                  ...
                  <div className="p-6 flex items-center gap-4">
                    ...
                    >
                      {task.completed ? (
                        ...
                        <Circle className="w-7 h-7 text-gray-400 hover:text-indigo-600" />
                      )}
                    </button>
